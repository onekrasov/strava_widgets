...
export class GeminiClient {
  ...
  async generateReport(goal: string, workStress: number): Promise<string> {
    ...
    const prompt = `Act as a professional endurance coach. 
      ...
      5. **Schedule Constrains** gym session is possible on Monday. Swimming sessions on Tuesday evening, Wednesday evening, Saturday morning or Sunday morning. Friday off/recover.
